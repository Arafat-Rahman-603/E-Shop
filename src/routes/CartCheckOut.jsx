...
function CartCheckout() {
    const finalAmount = useSelector(store => store.cartcheckout)
    ...
    <div className="container mt-5">
      <div className="card shadow-lg p-4">
        ...
        {finalAmount === undefined ? (
          <h2 className="text-center mb-4 text-primary">Total Ammount 0</h2>
        ) : (
          <h2 className="text-center mb-4 text-primary">
            Total Ammount:
           <i class="text-primary-emphasis"> {finalAmount}</i> TK
          </h2>
        )}
